...
function isReactElement(node2) {
  return (0, import_react8.isValidElement)(node2) && !(0, import_react_is.isFragment)(node2);
}
var supportNodeRef = function supportNodeRef2(node2) {
  return isReactElement(node2) && supportRef(node2);
};
var getNodeRef = Number(import_react8.version.split(".")[0]) >= 19 ? (
  // >= React 19
  function(node2) {
...
var Sider = React42.forwardRef((props, ref) => {
  ...
  const renderSider = () => {
    ...
    const iconObj = {
      expanded: reverseArrow ? React42.createElement(RightOutlined_default2, null) : React42.createElement(LeftOutlined_default2, null),
      collapsed: reverseArrow ? React42.createElement(LeftOutlined_default2, null) : React42.createElement(RightOutlined_default2, null)
    };
    ...
    return React42.createElement("aside", Object.assign({
      className: siderCls
    }, divProps, {
      style: divStyle,
      ref
  ...
  return React42.createElement(SiderContext.Provider, {
    value: contextValue
  }, renderSider());
});
if (true) {
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5CIS7MK6.js.map
